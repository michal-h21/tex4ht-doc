...
On the other hand, if you want to use pictures for math exclusively, you can try \option{pic-m}, which requires pictures even for inline math. There are also similar options for equations and other math environments.
...
For more information on options, see the chapter \namerefpage{chap:options}.

\section{\makefourht{} extensions}

\makefourht{} has an extension support. These extensions can modify various aspects of the conversion process.
