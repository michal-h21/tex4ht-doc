...
It is also possible to pass options in the \texcommand{\Preamble} command in a \cfgfile. Note that first option in the 
\texcommand{\Preamble} must be \option{xhtml}, invalid HTML file will be produced otherwise!
...
\item[1, 2, 3, 4, 5, 6, 7] for automatic sectioning pagination (to
  ...
  option \verb=1, 2, 3, 4,= \verb=5, 6, 7=. Option 1 doesn't break pages
  at all, 2 at parts, 3 at chapters, 4 at sections, 5 at subsections,
  6 at subsubsections and 7 at paragraphs.
