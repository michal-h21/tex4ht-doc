...
\begin{description}
  ...
  \item[2025/06/02] -- added \option{minipage-width} option.
  \item[2025/04/25] -- added \option{sec-slugname} and \option{fulltoc} options.
  \item[2024/11/20] -- documented the \option{fastmathjax} option.
  \item[2024/09/27] -- added new MathJax configurations. 
  \item[2024/09/10] -- updated debugging section to the tutorial.
  \item[2024/08/02] -- added the \option{texsource} option.
  ...
  \item[2023/03/22] -- extended info about the \cmd{Link} command.
  \item[2023/01/10] -- added the \option{nostyle} option.
