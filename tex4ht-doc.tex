...
\include{sections/calling-commands}
...
\begin{texsource}
\ConfigureEnv{arab}{\Configure{LRdir}{ dir="rtl"}}{\Configure{LRdir}{}}{}{}
\end{texsource}
...
not supported out of the box. By default, only most Latin based scripts are
...
The second option is to load support for a script in the custom config file using the \texcommand{\xeuniuseblock}:
