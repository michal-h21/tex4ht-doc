...
By default, \texfourht\ indents paragraphs. At the same time, vertical space
separating paragraphs is used by web browsers. It is better to use only one
method of paragraph separation in the document. Use the \option{p-indent} option to use
text indents, or the \option{p-space} option to use vertical spaces.
