...
The default CSS file \texfourht\ produces is initially a file consisting just
of a single line of the form \verb|‘/* css.sty */’|. That line is later
replaced with the code submitted by the \texcommand{\Css{...}} commands.

The current command allows to specify an alternative to the initial CSS file.
